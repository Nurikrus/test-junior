...
$jsonCars = file_get_contents($_SERVER["DOCUMENT_ROOT"] . "/data/data_cars.json");
$jsonAttempts = file_get_contents($_SERVER["DOCUMENT_ROOT"] . "/data/data_attempts.json");
...
$arrCars = json_decode($jsonCars, true);
$arrAttempts = json_decode($jsonAttempts, true);
